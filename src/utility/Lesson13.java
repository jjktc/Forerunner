 ...
 *
 *         Port of NeHe's Lesson 13 to LWJGL Title: Bitmap fonts Uses version
 *         0.9alpha of LWJGL http://www.lwjgl.org/
 *
 *         Be sure that the LWJGL libraries are in your classpath
 *
 *         Ported directly from the C++ version
 *
 *         The main point of this tutorial is to get fonts on the screen. The
 *         original OpenGL did not port directly as it used Windows specific
 *         extensions and I could not get some OpenGL commands to work. In the
 *         end, what you see on the screen is the same, but it is written
 *         somewhat differently. I have noted the differences in the code with
 *         comments.
 *
 *         2004-10-08: Updated to version 0.92alpha of LWJGL. 2004-12-19:
 *         Updated to version 0.94alpha of LWJGL
 */
public class Lesson13 {
    ...
    private boolean render() {
        ...
        GL11.glTranslatef(-0.9f + 0.05f * ((float) Math.cos(cnt1)), 0.32f * ((float) Math.sin(cnt2)), -2.0f); // Move
                                                                                                              // One
                                                                                                              // Unit
                                                                                                              // Into
                                                                                                              // The
    ...
    /*
     * Some liberties had to be taken with this method. I could not get the
     * glCallLists() to work, so it is done manually instead.
     */
    ...
    /*
     * The original tutorial number 13 used a windows specific extension to generate
     * a bitmap for the font. I had to replace that with a custom bitmap generation
     * that you see below.
     *
     */
    private void buildFont() { // Build Our Bitmap Font
        ...
        /*
         * Note that I have set the font to Courier New. This font is not guraunteed to
         * be on all systems. However it is very common so it is likely to be there. You
         * can replace this name with any named font on your system or use the Java
         * default names that are guraunteed to be there. Also note that this will work
         * well with monospace fonts, but does not look as good with proportional fonts.
         */
        ...
        /*
         * To find out how much space a Font takes, you need to use a the FontMetrics
         * class. To get the FontMetrics, you need to get it from a Graphics context. A
         * Graphics context is only available from a displayable surface, ie any class
         * that subclasses Component or any Image. First the font is set on a Graphics
         * object. Then get the FontMetrics and find out the width and height of the
         * widest character (W). Then take the largest of the 2 values and find the
        ...
        /*
         * Now that a font size has been determined, create the final image, set the
         * font and draw the standard/extended ASCII character set for that font.
         */
        ...
        /*
         * The following code is taken directly for the LWJGL example code. It takes a
         * Java Image and converts it into an OpenGL texture. This is a very powerful
         * feature as you can use this to generate textures on the fly out of anything.
         */
        // Flip Image
        ...
        /*
         * Generate the display lists. One for each character in the standard/extended
         * ASCII chart.
         */
