...
public class MPGameModes {
	...
	public static MPlayerGameMode[] gameModes = { new MPlayerGameMode("Team Deathmatch [coming soon]",
			"Destroy the other team and only one team will win.",
			...
			new MPlayerGameMode("Free-For-All [coming soon]",
					"Every-man-for-himself slaughter.Every person on the map is your enemy.",
			...
			new MPlayerGameMode("KnockOut",
					"Eliminate all the people on the opposite team.Once your down, you stay down.",
			...
			new MPlayerGameMode("Capture the Flag [coming soon]",
					"Two teams, two flags.Gain points for having both flags in your base.",
			...
			new MPlayerGameMode("Points-by-Possession [coming soon]",
					"Objects of worth give you points if you have them.Kill others to get the objects and try to keep them.",
			...
			new MPlayerGameMode("Tagger [coming soon]", "NO DESCRIPTION", "NO DESCRIPTION"),
			new MPlayerGameMode("Assassin [coming soon]", "NO DESCRIPTION", "NO DESCRIPTION"),
			...
			new MPlayerGameMode("Survival [coming soon]",
					"Survive as a team against onslaughts of CPUs with 1 goal.They are bent on killing you.",
			...
			new MPlayerGameMode("Co-Op Zombies [coming soon]",
					"The bodies of the dead have been re-animated.They have a odd craving for your flesh.They will do anything to get it.",
			...
			new MPlayerGameMode("Free-For-All Zombies [coming soon]",
					"A Zombie match with an added twist.You have to kill other people and zombies. Before either of them kill you.",
