...
public class Guns {
	...
	public static GunPositions defaultGPos = new GunPositions(
			...
			//new GunPosition(0.5f, -3, -15, 0f, -75f, -5f, 1, 125, false, 0, 0),//strafe left
			//new GunPosition(0.5f, -3, -15, 0f, -75f, -5f, 1, 125, false, 0, 0),//strafe right
	...
	public static Animation[] animStandardAssaultRifle = {
		new Animation("reload", new KeyFrame(0.5f, -1, -17, 0f, -75f, -65f, 0), new KeyFrame[] {
		...
		new Animation("reload_reset", new KeyFrame(0.5f, -1, -17, 0f, -75f, -65f, 0), new KeyFrame[] {
			new KeyFrame(0.5f, -1, -17, 0, -75, -65, 0),
			new KeyFrame(0.5f, -3, -15, 0f, -75f, -5f, 125)
		})
	};
	public static Animation[] animStandardPistol = {
		new Animation("reload", new KeyFrame(5.5f, 2f, -25f, -45f, -75f, -45f, 0), new KeyFrame[] {
			new KeyFrame(5.5f, 2f, -25f, -45f, -75f, -45f, 0),
			new KeyFrame(4f, -15f, -25f, -45f, -75f, -45f, 375),
			new KeyFrame(4f, -15f, -25f, -45f, -75f, -45f, 125),
			new KeyFrame(5.5f, 2f, -25f, -45f, -75f, -45f, 375)
		}),
		new Animation("reload_reset", new KeyFrame(5.5f, 2f, -25f, -45f, -75f, -45f, 0), new KeyFrame[] {
			new KeyFrame(5.5f, 2f, -25f, -45f, -75f, -45f, 0),
	...
	public static void init() {
		guns.add(new WeaponGun("Standard Assault Rifle", defaultGPos, new ItemMagazine(new ItemBullet(1, null), 30, new AnimModel(Models.models.get(Models.MODEL_STANDARDASSAULTRIFLECLIP), new KeyFrame(0.5f, -3, -15, 0f, -75f, -5f, 0), animStandardAssaultRifle), null), Sprites.gi_standardassaultrifle, Models.models.get(Models.MODEL_STANDARDASSAULTRIFLE), true, 16, 0.75f, 10, 300, 150, 180));
		guns.add(new WeaponGun("Standard Pistol", gposStandardPistol, new ItemMagazine(new ItemBullet(1, null), 8, new AnimModel(Models.models.get(Models.MODEL_STANDARDPISTOLCLIP), new KeyFrame(3.25f, -1.75f, -17.5f, 0f, -75f, -5f, 0), animStandardPistol), null), Sprites.gi_standardpistol, Models.models.get(Models.MODEL_STANDARDPISTOL), false, 13, 0.85f, 1, 50, 80, 88));
	}
