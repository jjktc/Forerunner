...
public class Gamepad {
	...
	public static void updateLauncherSelection(int lookup, ClickerText... ct) {
		...
		if(lookups.get(lookup) < 0) lookups.set(lookup, 0);
		if(lookups.get(lookup) > ct.length - 1) lookups.set(lookup, ct.length - 1);
