...
public class StateMultiplayer extends State {
	...
	public Btn play1v1 = new Btn(Sprites.play, Sprites.play_hover, Sprites.play_clicked, "", 38 + Fonts.fontDefault.getWidthByString("Play IP-Based 1v1 MP Beta 1:", 1), 56, 1, 1, new Runnable() {
		public void run() {
	...
	public TabMenu tabMenu = new TabMenu(0, 0, 1, new Tab[] {
			...
			new Tab(false, "Game Info", Sprites.mpTInfo, Sprites.tab, Sprites.tab_hover, Sprites.tab_clicked, new Runnable() {
				public void run() {
			...
			new Tab(false, "Loadouts", Sprites.mpTLoadouts, Sprites.tab, Sprites.tab_hover, Sprites.tab_clicked, new Runnable() {
				public void run() {
			...
			new Tab(false, "Friends", Sprites.mpTFriends, Sprites.tab, Sprites.tab_hover, Sprites.tab_clicked, new Runnable() {
				public void run() {
			...
			new Tab(false, "Play", Sprites.mpTMatch, Sprites.tab, Sprites.tab_hover, Sprites.tab_clicked, new Runnable() {
				public void run() {
					play1v1.update();
				}
			}, new Runnable() {
