...
public class StateSettings extends State {
	...
	public CheckBox joystick = new CheckBox(8, 150, false, "Use Joystick", Sprites.checkbox, Sprites.checkbox_hover, Sprites.check, 1, new Runnable() {
		public void run() {
	...
	public CheckBox graphicContent = new CheckBox(8, 168, true, "Graphic Content", Sprites.checkbox, Sprites.checkbox_hover, Sprites.check, 1, new Runnable() {
		public void run() {
