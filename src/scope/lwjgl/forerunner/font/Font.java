...
public class Font {
	...
	public Char cA, cB, cC, cD, cE, cF, cG, cH, cI, cJ, cK, cL, cM, cN, cO, cP, cQ, cR, cS, cT, cU, cV, cW, cX, cY, cZ;
	public Char cPeriod, cExclamation, cQuestion, cComma, cSQuote, cDQuote, cBSlash, cFSlash, cLParan, cRParan,
			cLBracket, cRBracket, cLBrace, cRBrace, cPlus, cEquals, cMinus, cDollar, cApostrophe, cCopyright,
			cRegistered, cTrademark, cLArrow, cRArrow, cUArrow, cNumber, cPole, cPercent, cColan, cSColan;
	...
	public void drawString(String text, int x, int y, float scale) {
		...
		for (int i = 0; i < text.length(); i++) {
			...
			x2 += lwidth;
			/*
			 * if(width >= Launcher.width) { x2 = 0; y2 += 17; width = 0; }
			 */
			if (c != ' ') {
