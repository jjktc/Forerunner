...
public class TridemDisplay {
	...
	public TridemDisplay(float x, float y, float z, float rotX, float rotY, float rotZ, float width, float height,
			int pixelX, int pixelY, Runnable updateDisplay, Runnable renderDisplay) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.rotX = rotX;
	...
	public static void renderSprite(Sprite sprite, TridemDisplay display, int x, int y, float scale) {
		...
		glVertex3f((x + sprite.width * scale) * display.pixelWidth, (y + sprite.height * scale) * display.pixelHeight,
				0);
		glTexCoord2f(x2, y2);
	...
	public static void renderSprite(Sprite sprite, TridemDisplay display, int x, int y, float scale, float r, float g,
	...
	public static void renderSprite(Sprite sprite, TridemDisplay display, int x, int y, int width, int height, float r,
