...
public class Sprite {
	...
	public void render3d(float x, float y, float z, float rotX, float rotY, float rotZ, float scale, float r, float g, float b, float opacity) {
		glColor4f(r, g, b, opacity);
		render3d(x, y, z, rotX, rotY, rotZ, scale);
		glColor4f(1f, 1f ,1f, 1f);
	}
	
	public void render3d(float x, float y, float z, float rotX, float rotY, float rotZ, int width, int height, float r, float g, float b, float opacity) {
		glColor4f(r, g, b, opacity);
