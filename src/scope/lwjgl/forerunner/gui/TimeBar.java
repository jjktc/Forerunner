...
public class TimeBar {
	...
	public TimeBar(Sprite bar, Sprite progressSection, int x, int y, float scale, int xS, int yS, float scaleS,
			int width, int time, int startTime, float rate, boolean active, Runnable method) {
		this.bar = bar;
