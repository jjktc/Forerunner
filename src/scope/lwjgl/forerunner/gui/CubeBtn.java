		...
		if (type2 == 0) {
			...
			case 0:
				...
				Fonts.fontDefault.drawString(text,
						(int) (x + (48 / 2) * scale) - Fonts.fontDefault.getWidthByString(text, fontScale) / 2,
						(int) (y + (48 / 2) * scale) - Fonts.fontDefault.getHeightByString(text, fontScale) / 2,
						fontScale, 0, 0, 0, 1f);
				break;
			case 1:
				Sprites.cube_btn2.render(x, y, scale);
				Fonts.fontDefault.drawString(text,
						(int) (8 * scale + (x + (48 / 2) * scale)
								- Fonts.fontDefault.getWidthByString(text, fontScale) / 2),
						(int) (8 * scale + (y + (48 / 2) * scale)
			...
			case 2:
				...
				Fonts.fontDefault.drawString(text,
						(int) (12 * scale + (x + (48 / 2) * scale)
								- Fonts.fontDefault.getWidthByString(text, fontScale) / 2),
						(int) (12 * scale + (y + (48 / 2) * scale)
								- Fonts.fontDefault.getHeightByString(text, fontScale) / 2),
						fontScale, 0, 0, 0, 1f);
				break;
			}
			...
			case 0:
				Sprites.cube_btn.render(x, y, scale);
				regular.render((int) ((x + (48 / 2) * scale) - regular.width * fontScale / 2),
						(int) ((y + (48 / 2) * scale) - regular.height * fontScale / 2), fontScale);
				break;
			case 1:
				Sprites.cube_btn2.render(x, y, scale);
				regular.render((int) (8 * scale + (x + (48 / 2) * scale) - regular.width * fontScale / 2),
						(int) (8 * scale + (y + (48 / 2) * scale) - regular.height * fontScale / 2), fontScale);
				break;
			case 2:
				Sprites.cube_btn3.render(x, y, scale);
				regular.render((int) (12 * scale + (x + (48 / 2) * scale) - regular.width * fontScale / 2),
						(int) (12 * scale + (y + (48 / 2) * scale) - regular.height * fontScale / 2), fontScale);
				break;
			}
		}
	}
