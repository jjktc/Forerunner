...
public class Menu {
	...
	public static int state;// 0 = nothing, 1 = opening width, 2 = opening height, 3 = closing width, 4 =
							// closing height, 5 = small_nothing, 6 = small_opening width, 7 = small_opening
							// height, 8 = small_closing width, 9 = small_closing height
	public static String sName = "";
	public static Runnable sUpdate;
	public static Runnable sRender;
	public static Btn btnQuit = new Btn(Sprites.menuBtn, Sprites.menuBtn_hover, Sprites.menuBtn_clicked, "Quit",
			(Main.width - Sprites.menuBtn.width) / 2, (int) (Main.height - Sprites.menuBtn.height * 1.5), 1, 2,
			new Runnable() {
				public void run() {
					Main.kill();
				}
	...
	public static Btn btnWeaponStats = new Btn(Sprites.menuBtn, Sprites.menuBtn_hover, Sprites.menuBtn_clicked,
			"Weapon Stats", (Main.width - Sprites.menu.width) / 2 + 8, 16, 1, 1, new Runnable() {
				public void run() {
					openSmallMenu(0, 0, 0, "weapon_stats", new Runnable() {// 2
						...
						public void run() {
							...
							Fonts.fontDefault.drawString("Rate Of Fire:" + World.player.selectedWeapon.rateOfFire, 4,
									46, 1);
	...
	public static Btn btnCloseSmallMenu = new Btn(Sprites.menu_small_back, Sprites.menu_small_back_hover,
			Sprites.menu_small_back_clicked, "", 0, 0, 1, 1, new Runnable() {
				public void run() {
					closeSmallMenu();
				}
			}, false);
