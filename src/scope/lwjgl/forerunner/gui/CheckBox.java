...
public class CheckBox {
	...
	public CheckBox(int x, int y, boolean def, String text, Sprite checkbox, Sprite checkbox_hover, Sprite check,
			float scale, Runnable method) {
		this.x = x;
		this.y = y;
	...
	public void render() {
		...
		Fonts.fontDefault.drawString(text, (int) (x + scale + checkbox.width * scale),
				(int) (y + (checkbox.height * scale - Fonts.fontDefault.colH * scale) / 2), scale);
	}
