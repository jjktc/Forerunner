...
public class HudMap {
	...
	public static void render() {
		...
		renderEnemies();
		renderDirection();
		Sprites.map_player.render(4 + (Sprites.map.width - Sprites.map_player.width) / 2, Main.height - 184 + ((Sprites.map.height + 18) - Sprites.map_player.height) / 2, 1, 1, 1, 1, 0.9f);
	}
