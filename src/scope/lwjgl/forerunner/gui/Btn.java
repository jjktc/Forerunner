...
public class Btn {
	...
	public Btn(Sprite regular, Sprite hover, Sprite clicked, String text, int x, int y, float scale, float fontScale, Runnable method, boolean blocked) {
	...
	public void render() {
		switch(type) {
			case 0:
				...
				if(!text.equals("")) Fonts.fontDefault.drawString(text, (int) (x + (regular.width / 2) * scale) - Fonts.fontDefault.getWidthByString(text, fontScale) / 2, (int) (y + (regular.height / 2) * scale) - Fonts.fontDefault.getHeightByString(text, fontScale) / 2, fontScale);
				break;
			case 1:
